...
class Parser:
    def __init__(self, lexer, emitter):
        ...
        self.symbols = set()  # Stores variables declared so far.
        self.labelsDeclared = set()  # Stores labels declared so far.
        self.labelsGotoed = set()  # Stores labels goto'e so far.
    ...
    # Return true if the current token is a comparator operator.
